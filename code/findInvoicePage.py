...
def findInvPage(imgpath, tmpdir):
    ...
    for pageNo,img in enumerate(imgs):
        ...
        if fileWritten:
            ...
            if invPage:
                print("Invoice Page: ", pageNo + 1)
            else:
                print("Non Invoice Page: ", pageNo + 1)
    ...
    for pageNo, img in enumerate(imgs):
        if (pageNo >= firstInvPage) and (pageNo < lastInvPage):
            ...
            nonInvPages.append(img)

    return invPages,nonInvPages


tempdir = r"D:\Invoice Data Extraction\TAPP 3.0\taggedData\images\test"
filepath = r"D:\Invoice Data Extraction\TAPP 3.0\taggedData\images\test\Allport.TIFF"

invPages,nonInvPages = findInvPage(filepath,tempdir)
